...
async def func_ytdl(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await effective_message.reply_text("Downloading...")
    ...
    await effective_message.reply_audio(response["file_path"], title=file_name, filename=file_name, reply_to_message_id=effective_message.id)
