...
class QueryFunctions:
    async def query_edit_value(identifier, query, is_list=bool(False), is_int=bool(False)):
        """
        identifier > user.id or chat.id\n
    ...
    async def query_bool_true(identifier, query):
        """
        identifier > user.id or chat.id\n
        data center identifier\n
        query > query indicator
    ...
    async def query_bool_false(identifier, query):
        """
        identifier > user.id or chat.id\n
        data center identifier\n
        query > query indicator
