...
async def _check_permission(update: Update, victim=None, user=None):
    ...
    return _bot, bot_permission, user_permission, victim_permission
...
async def func_invite_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await Message.send_msg(chat.id, f"Group invite link: {invite_link.invite_link}\nGenerated by: {user.mention_html()}")
