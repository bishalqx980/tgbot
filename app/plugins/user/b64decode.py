...
__module__ = {
    ...
    "name": "decode",
    "commands": ["decode"], # list of commands including aliases

    "description": "Decode base64 string! E.g. `/decode aHR0cHM6Ly9iaXNoYWxxeDk4MC5naXRodWIuaW8v` or reply the string with command!",
    "category": "user", # check app/__init__.py for HELP_MENU_CATEGORIES
    "button_name": "Decode base64", # Help menu button name (Note: Leaving blank or None will result in no button on help menu)
...
async def func_(_, message: Message):
    ...
    await message.reply(
        f"`{res}`" if res else "Error: Huh! Don't mess with me, It's an invalid base64!!"
    )
