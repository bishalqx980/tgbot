...
def build_keyboard(current_list: List[str]) -> InlineKeyboardMarkup:
    ...
    x = ["Option1", "Option2", "Option3", "00000"]
    return InlineKeyboardMarkup.from_column(
        [InlineKeyboardButton(str(i), callback_data=(i, current_list)) for i in x] #range(1, 5)]
    )
...
def main() -> None:
    ...
    application = (
        Application.builder()
        .token("6734963977:AAE2y_gfEULKMK8uMn7hmucQzNJDV6bdRbk")
